...
const ButtonNew = <E extends React.ElementType = "button">({
  startIcon,
  endIcon,
  children,
  isLoading = false,
  ...
  const textProps = {
    ...
    color: isDisabled || fakeDisabled ? ("darkGray" as const) : ("darkGray" as const),
    textTransform: "uppercase" as const,
    fontSize: scale === "sm" ? ("20px" as const) : ("18px" as const),
    fontFamily: "Sifonn",
  };
